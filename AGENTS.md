...
- Keep every DELEGATED app-* stage with one persistent repo-L2 of kind `repo-orchestrator` and one stable owner-session ref.
- Keep L1 `workflow-orchestrator` limited to opening and continuing repository lanes.
