...
- Do not add autoCD controller code, webhook receivers, Git post-receive hooks, or deployment fallbacks. The external controller invokes this repo's explicit installer only after its SHA gate and operator handoff.
