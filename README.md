...
Canonical role TOML files live in the plugin `agents/` catalog. Plugin-root agent auto-discovery is undocumented, so explicit installer registration remains required after source updates:
