...
Graph Workflow v3 role/runtime hardening was introduced in `0.3.2`; the current plugin release is `0.3.3`. A `1.0.0` release requires an explicit user request.
