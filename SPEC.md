...
Active discoverable skills: `bears-blocker-eval`, `bears-deploy-gate`, `bears-goal-prompt`, `bears-codex-health`, `bears-governance-check`, `bears-role-gate`, `bears-workflow-validate`, `development-workflow-orchestration`, `platform-role-governance`, `python-codeflow`, `project-mandate`, `secret-factory`, `speckit-bears-flow`, `speckit-bears-research`, `bears-project-constitution`, `bears-project-specify`, `app-docs2project-bears`, `github-project-planning`, `bears-project-analyze`, `yandex360-dns`, `bears-kubernetes-ops`, `bears-infisical-ops`, `subagents`, `projectdevsubagents`, `codex-telegram-operator-gate`.
