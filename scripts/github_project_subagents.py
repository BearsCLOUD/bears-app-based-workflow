...
RUNTIME_PROXY_REQUIRED_MARKERS = (
    ...
    "smaller Issue or issue comment",
    "240 seconds",
    "270 seconds",
    "300 seconds",
    "one issue",
    "one L3 max",
    "one target file or contract",
    "one validation path",
    "timeout",
    "broad Project scans",
    ...
    "CLEANUP_PASS",
    "separate first-class L2 lane",
    "shorter cleanup cutoff than implementation lanes",
    "exactly one cleanup target",
    "one status proof command",
    "no issue metadata mutation unless explicitly assigned",
    "parent cutoff",
    "post-cutoff cleanup success",
    "BearsCLOUD/apps#105",
    "BearsCLOUD/apps#110",
