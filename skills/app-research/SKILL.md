---
name: app-research
description: Create, update, synchronize, and refine Bears app research waves that explain constitution ids before planning. Use when Codex must turn app intent, constitution gaps, sources, existing docs, or unknowns into wave research packets.
---
...
- `docs/app-constitution.md` capabilities, constraints, gaps, and decisions.
- Existing wave registry and wave docs.
- Source docs, code observations, tickets, product notes, host policy notes when supplied, and user answers.
...
5. Use `app-specify` only as a clarification helper when actors, flows, data, errors, or acceptance details cannot be resolved from sources.
