...
6. Request primary-source research only when a current framework API, profile format, capability, permission behavior, or production implementation can change the decision. Keep research read-only and separate facts from design choices.
